...
const BREADCRUMB_LABELS: Record<string, string> = {
  ...
  'silikonovaya-shtukaturka-belgiya-bryussel-antverpen-nanesenie-silikonovoy-shtukaturki': 'Силиконов',
  ...
  'gipsokartonshchik-essen-demontazh-i-montazh-gipsokartona': 'Гипсокартонщик Эссенция',
  ...
  'montazh-bashennyh-kranov-myullaker-montazh-bashennyh-kranov-sborka-i-razborka': 'Монтаж Башенных Кранов',
  'podsobnyy-rabochiy-wurzburg-pomoshchnik-na-mashinnuyu-shtukaturku': 'Подсобный рабочий Вюрбрг',
