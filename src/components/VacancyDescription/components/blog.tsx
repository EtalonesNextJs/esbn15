  ...
  return (
    <section
        ...
        >
          <SectionHeading
            heading="Блог"
            content="Тематические посты о работе в Европе."
          />
...
<motion.div
              ...
              > 
        <div className="container w-full max-w-xs md:max-w-screen-md lg:max-w-screen-xl mx-auto px-12">
...
const TestimonialCard = ({
  ...
  <div className="mb-8 max-w-screen-md md:max-w-screen-xl bg-accent rounded-xl py-6 px-4 sm:px-6">
    <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-20">
      ...
      {/* Контент */}
      <div className="flex flex-col justify-center text-center lg:text-left w-full max-w-2xl">
        ...
        {/* Текст отзыва */}
        <p className="mt-6 text-base sm:text-lg leading-relaxed font-medium tracking-tight">
